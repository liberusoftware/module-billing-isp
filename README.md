# Billing: Isp Core Module

> This package is the authoritative, provider-neutral implementation of Isp. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-isp?sort=semver)](https://github.com/liberusoftware/module-billing-isp/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-isp/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-isp/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-isp
```
...
<a href="https://github.com/liberusoftware/module-billing-isp/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-isp" alt="Contributors to liberusoftware/module-billing-isp">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-isp/graphs/contributors).
